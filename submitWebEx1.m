function submitWebEx1(partId)
%SUBMITWEBEX1 Generates a base64 encoded string for web-based submissions
%   SUBMITWEBEX1() will generate a base64 encoded string so that you can submit your
